 ...
 */
public class ReportQueue implements TenantCommand {
    String outputPath;

    public ReportQueue(String outputPath) {
    ...
    public void execute(Server server, Tenant tenant, Reporter reporter) {
        ...
        List<RMSInstance> all = server.getRmsReaderAPI().readResources("WQVertica");
